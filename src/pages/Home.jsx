...
```
    <div className="container hero__inner">
      <div className="hero__copy">
        ...
        <div className="hero__actions">
          <Button as={Link} to="/services#get-a-quote" size="lg">
            Get a Quote
          </Button>

          <Button as={Link} to="/contact#contact-form" variant="secondary" size="lg">
            Talk to Dispatch
          </Button>
        </div>
      </div>
  ...
  <section className="section fleet-section">
    <div className="container">
      ...
      <Reveal delay={100}>
        <TruckSlider slides={FLEET_SLIDES} />
      </Reveal>
    </div>
  </section>
    ...
    <div className="container">
      ...
      <div className="home-grid">
        {WHY_CHOOSE_US.map((item) => (
          <Reveal key={item.title} delay={WHY_CHOOSE_US.indexOf(item) * 80}>
            <Card {...item} />
          </Reveal>
        ))}
      </div>
  ...
  <section className="cta-banner">
    <div className="container cta-banner__inner">
      ...
      <div className="cta-banner__actions">
        ...
        <Button as={Link} to="/contact#contact-form" variant="ghost" size="lg">
          Contact Us
        </Button>
      </div>
    </div>
